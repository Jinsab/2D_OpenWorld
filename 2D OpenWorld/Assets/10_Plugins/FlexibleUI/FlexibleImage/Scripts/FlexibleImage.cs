...
public partial class FlexibleImage : Image, IMeshModifier
{
    ...
    public static readonly string QuadDataContainerFieldName = nameof(_quadDataContainer);
    ...
    [SerializeField] private QuadDataContainer _quadDataContainer = new();

    // Helpers to easily get/set values on the primary quad / animation substate.
    public QuadDataContainer ActiveQuadDataContainer => DataMode == QuadDataMode.Preset && QuadDataPreset != null && QuadDataPreset.quadDataContainer != null ? QuadDataPreset.quadDataContainer : _quadDataContainer;
