...
{
[Serializable]
public class QuadDataContainer : ISerializationCallbackReceiver
{
#if UNITY_EDITOR
    ...
    {
        var newQuadData = new QuadData(this);
    ...
    public void MessageVerticesDirty() => VerticesDirtyEvent?.Invoke();
