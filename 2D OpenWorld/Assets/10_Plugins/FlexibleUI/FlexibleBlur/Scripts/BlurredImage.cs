...
public class BlurredImage : Image, IBlur
{
    ...
    private void CalculateBlur()
    {
        ...
        Common.CacheBlur(canvas, rectTransform, Vector2.zero, 0f, false, Vector2.zero, additionalBlurPadding);
        Common.ComputeBlurCommon(canvas, rectTransform, Vector2.zero, 0f, false, Vector2.zero, additionalBlurPadding);
    }
