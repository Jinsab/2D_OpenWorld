 ...
 *  마지막 수정 일자 : 26.03.26 오후 16:48
 *  
 *  [스크립트 목적 및 내용]
 *  1. 쓰레기통 기능
 *    1-1. InventoryData를 사용하는 것이 아님
 *    1-2. InventorySlot 객체 딱 하나만 관리하는 UI 슬롯
 *    1-3. 아이템을 쓰레기통 슬롯에 드롭 가능
 *    1-4. 실수로 버린 경우 다시 꺼낼 수 있도록 '마지막으로 버린 아이템' 1개만 유지
 *      
 *  [스크립트 작성 도움 출처]
 *  1. 
 */
